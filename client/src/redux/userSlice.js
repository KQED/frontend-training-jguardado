...
// add a lading state into my reducer functions
const userSlice = createSlice({
  ...
  reducers: {
    ...
    getAllUsers: (state, action) => {
      ...
      state.loading = false
      localStorage.setItem('users', JSON.stringify(state.data)) // Not needed now, use later. 
    },
    modifyUser: (state, action) => {  // reducer for modifying user data
      // get rd of this, addUser can take place of this reducer.
    }
  }
})
